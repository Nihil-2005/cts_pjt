"""DevSecOps Risk Intelligence Pipeline — 8-stage vulnerability processing.
...
Stages:
  ...
  7. Remediate   — first-aid + full remediation + scanner guidance
  8. Output      — ranking, CSV/JSON/markdown, dashboard, tickets
"""
__version__ = "2.0.0"
